...
PATH.NMF.ADNI <- '../../nmf/adni/results/mat/NumBases6.mat'
PATH.NMF.OASIS <- '../../nmf/oasis3/results/mat/NumBases6.mat'
PATH.MATCH <- '../figS1/adni_v_oasis_compare/matching/Match6.mat'
...
for (i in 1:6) {
  ...
  ggsave(savename, p, width=3.74, height=.7, units='in')
}

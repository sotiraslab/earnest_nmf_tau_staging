...
FULL_X_PATH = '../../derivatives/adni/nmf_matrix.csv';
SPLITS_PATH = '../../derivatives/adni/reproducibility_split_indices.csv';
OUTPUTDIR = 'results';
...
% run!
REP_DIR = fullfile(OUTPUTDIR, 'repeat_reproducibility_raw');

for n = 1:N
    
    disp('...');
    disp('...');
    disp(sprintf('REPEAT %d', n));
    disp('...');
    disp('...');
    pause(1);
